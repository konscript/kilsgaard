			...
			<div class="entry-utility">
				...
				*/
				...
				?>
					...
					<span class="meta-sep">|</span>
				<?php endif; ?>
				<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'penis' ), __( '1 Comment', 'penis' ), __( '% Comments', 'penis' ) ); ?></span>
				<?php edit_post_link( __( 'Edit', 'penis' ), '<span class="meta-sep">|</span> <span class="edit-link">', '</span>' ); ?>
			</div><!-- .entry-utility -->
		</div><!-- #post-## -->
